...
<footer class="main-footer">
    <strong>Developed by savage group.</strong>
...
<script src="components/bs-custom-file-input/bs-custom-file-input.min.js"></script>
<!-- AdminLTE App -->
...
<script>document.title='<?php echo $title?> | Friends-Chat';</script>
