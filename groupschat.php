...
$messageData=mysqli_query($conn, "select * from messages where groupId=$groupId order by sentDate");
            ...
            <div class="col-md-6 col-12">
              <div class="card card-primary cardutline direct-chat direct-chat-primary">
                <div class="card-header">
                  <h3 class="card-title"><img class="img-circle elevation-2" src="<?php echo $groupPhoto ?>" alt="Group Image" style="width: 30px !important; height: 30px;"><span style="font-size: 22px;">&nbsp;&nbsp;<?php echo $groupName ?></span></h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                ...
                <div class="card-body">
                  ...
                  <div class="collapse" id="settingForm">
                    <div class="card card-body">
                      ...
                      <?php endif; ?> 
                      <div>
                        <form action="groupschat.php?groupId=<?php echo $groupId ?>" method="post" id="groupsettingform">
                                ...
                                <!-- <ul style="list-style: none;"> -->
                                  ...
                                  <li style="list-style: none; margin-bottom: 10px;">
                                    <div class="row">
                                      ...
                                      <div class="col-md-2 col-2"><button type="button" id="btnDelete" data-id="<?php echo $groupmemberslist["mId"] ?>" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deletemodel"><i class="fa fa-trash"></i></button>
                                      </div>
                                    </div>
                                  </li>
