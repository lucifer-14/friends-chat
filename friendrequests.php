...
if(isset($_GET['friendrequestId'])){
  $friendrequestId=preg_replace('/[^0-9]/', '', $_GET['friendrequestId']);
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="card card-primary card-outline">
            <?php if (is_numeric($friendrequestId)) : ?>
            <?php if (isset($_GET['friendrequestId']) && mysqli_num_rows($friendRequestsData)>0) : ?>
            <div class="card-body">
              <div class="row">
